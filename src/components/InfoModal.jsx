  ...
  return (
    <dialog id="my_modal_1" className="modal" ref={dialog}>
      <div className="modal-box">
        ...
        <p className="py-4">
          I hope you will enjoy this application. This is my first personal
          project with React. I am very excited to immerse myself in React
          concepts and environment as a software engineer. Thanks for visiting
          this site.
          <br /> Have a good day! ☀️
        </p>
        <p className="my-4">
          Also, if you have any advice for improving this project or just want
          to chat, you can find me there.
        </p>
